...
class L10nHuBaseObject(models.Model):
    ...
    def run_object_api_cron(self):
        ...
        try:
            self.env['l10n.hu.plus.log'].create(log_values)
        except:
            self.env['l10n.hu.plus.log'].sudo().create(log_values)
    ...
    def get_tags_by_technical_name(self):
        ...
        tags = self.env['l10n.hu.plus.tag'].sudo().search([
